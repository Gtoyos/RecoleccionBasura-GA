    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<10000; i++)
        	for (int j=0; j<10000; j++) {
        		costMatrixBuilder.addTransportDistance(String.valueOf(i), String.valueOf(j), i*3+j*4);
        		costMatrixBuilder.addTransportTime(String.valueOf(i), String.valueOf(j), i*3+j*4);
        	}
